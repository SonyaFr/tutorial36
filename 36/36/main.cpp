...
public:
    ...
    bool Init()
    {
        ...
        if (!m_quad.LoadMesh("D:/1/dev2/project/Content/quad.obj")) {
            return false;
        }

        if (!m_box.LoadMesh("D:/1/dev2/project/Content/box.obj")) {
			return false;
		}

        if (!m_bsphere.LoadMesh("D:/1/dev2/project/Content/sphere.obj")) {
			return false;
		}
